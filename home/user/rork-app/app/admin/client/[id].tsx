...
export default function ClientDetailScreen() {
  ...
  const allHabits = Object.values(clientHabits).sort((a: DailyHabits, b: DailyHabits) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.scrollView}>
        <View style={styles.content}>
            ...
            <View style={styles.statsContainer}>
              ...
              <View style={styles.statItem}>
                <Text style={styles.statValue}>
                  {allHabits.filter((h: DailyHabits) => h.championWorkout === 'yes').length}
                </Text>
              ...
              <View style={styles.statItem}>
                <Text style={styles.statValue}>
                  {allHabits.length > 0 
                    ? Math.round(allHabits.reduce((sum: number, h: DailyHabits) => sum + (h.energyLevel2pm as number), 0) / allHabits.length) 
                    : 0
                  }/10
                </Text>
              ...
              <View style={styles.habitSummary}>
                ...
                <View style={styles.buttonContainer}>
                  <Button
                    ...
                    onPress={() => handleViewHabit(currentDateHabits)}
          ...
          {allHabits.length > 0 ? (
            allHabits.map((habit: DailyHabits) => (
              <HabitHistoryCard 
                key={habit.date}
                habits={habit as DailyHabits}
                clientId={id}
